...
X_PR = zeros(Test_number,num_of_training);
Y_PR = zeros(Test_number,num_of_training);
X_AUC = zeros(Test_number,num_of_training);
Y_AUC = zeros(Test_number,num_of_training);
